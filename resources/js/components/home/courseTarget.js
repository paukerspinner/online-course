                ...
                <div className="row justify-content-md-center">
                    ...
                    <div className="col-sm-12 col-lg-6 mt-4">
                        <div className="card-target h-100">
                            ...
                            <div className="card-text">
                                <h4>Requirements for the preliminary preparation of the student</h4>
                    ...
                    <div className="col-sm-12 col-lg-6 mt-4">
                        <div className="card-target h-100">
                            ...
                            <div className="card-text">
                                <h4>Methodical instructions for students on mastering the course</h4>
                    ...
                    <div className="col-sm-12 col-lg-6 mt-4">
                        <div className="card-target h-100">
                            ...
                            <div className="card-text">
                                <h4>Result of mastering the course, the student must</h4>
